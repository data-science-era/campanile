...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="RealCampanile",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC13RealCampanile11AppDelegate")
...
SWIFT_CLASS("_TtC13RealCampanile27RealCampanileViewController")
@interface RealCampanileViewController : UIViewController
...
- (IBAction)startStopButton:(id _Nonnull)sender;
- (IBAction)pauseTimer:(id _Nonnull)sender;
- (void)viewDidLoad;
- (void)updateTimerWithTimer:(NSTimer * _Nonnull)timer;
...
SWIFT_CLASS("_TtC13RealCampanile13SceneDelegate")
